import{j as s}from"./iframe-IwT84T3c.js";import{c as h}from"./createSvgIcon-BYuvrw-D.js";import{s as B}from"./styled-CDRqgd7X.js";import{B as f}from"./Button-DZQQ_t4y.js";import"./createSimplePaletteValueFilter-D8TDwMFs.js";import"./ButtonBase-CtXANbeg.js";import"./assertThisInitialized-BjnbojEp.js";const S=h(s.jsx("path",{d:"M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"})),k=B(f)(({theme:o,variant:n})=>({backgroundColor:n==="contained"?o.palette.primary.main:(o.palette.mode==="dark","transparent"),color:n==="contained"||o.palette.mode==="dark"?o.palette.common.white:o.palette.primary.main,textTransform:"none",lineHeight:"initial",border:n==="outlined"?`1px solid ${o.palette.primary.main}`:"none",borderRadius:"8px",boxShadow:n==="contained"?"0px 4px 6px rgba(0, 0, 0, 0.1)":"none",transition:"transform 0.3s ease, opacity 0.3s ease, box-shadow 0.3s ease","&:hover":{backgroundColor:n==="contained"||n==="outlined"||o.palette.mode==="dark"?o.palette.action.hover:"transparent",cursor:"pointer",opacity:.9,transform:"scale(1)",boxShadow:n==="contained"?"0px 6px 10px rgba(0, 0, 0, 0.15)":"none","& span":{transform:"translateX(3px)"}},"&:active":{transform:"scale(0.98)",boxShadow:n==="contained"?"0px 3px 8px rgba(0, 0, 0, 0.2)":"none"}})),I=B(f)(({theme:o})=>({lineHeight:"initial",border:"none",borderRadius:"8px",boxShadow:"0px 4px 6px rgba(0, 0, 0, 0.1)",transition:"transform 0.3s ease, opacity 0.3s ease, box-shadow 0.3s ease",color:o.palette.common.white,textTransform:"none",backgroundColor:o.palette.info.main,"&:hover":{backgroundColor:o.palette.info.main,cursor:"pointer",opacity:.9,transform:"scale(1)",boxShadow:"0px 6px 10px rgba(0, 0, 0, 0.15)","& span":{transform:"translateX(3px)"}}})),D={title:"Components/Buttons/StyledButton",component:k,tags:["autodocs"],parameters:{docs:{description:{component:`
### 🔘 StyledButton

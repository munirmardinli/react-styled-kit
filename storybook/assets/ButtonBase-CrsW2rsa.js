...
`,te=u.forwardRef(function(t,n){const i=lt({props:t,name:"MuiTouchRipple"}),{center:s=!1,classes:r={},className:o,...c}=i,[l,f]=u.useState([]),d=u.useRef(0),h=u.useRef(null);u.useEffect(()=>{h.current&&(h.current(),h.current=null)},[l]);const M=u.useRef(!1),V=Xt(),b=u.useRef(null),D=u.useRef(null),T=u.useCallback(p=>{const{pulsate:E,rippleX:R,rippleY:F,rippleSize:w,cb:U}=p;f(y=>[...y,j.jsx(Qt,{classes:{ripple:x(r.ripple,g.ripple),rippleVisible:x(r.rippleVisible,g.rippleVisible),ripplePulsate:x(r.ripplePulsate,g.ripplePulsate),child:x(r.child,g.child),childLeaving:x(r.childLeaving,g.childLeaving),childPulsate:x(r.childPulsate,g.childPulsate)},timeout:J,pulsate:E,rippleX:R,rippleY:F,rippleSize:w},d.current)]),d.current+=1,h.current=U},[r]),$=u.useCallback((p={},E={},R=()=>{})=>{const{pulsate:F=!1,center:w=s||E.pulsate,fakeElement:U=!1}=E;if((p==null?void 0:p.type)==="mousedown"&&M.current){M.current=!1;return}(p==null?void 0:p.type)==="touchstart"&&(M.current=!0);const y=U?null:D.current,I=y?y.getBoundingClientRect():{width:0,height:0,left:0,top:0};let B,C,S;if(w||p===void 0||p.clientX===0&&p.clientY===0||!p.clientX&&!p.touches)B=Math.round(I.width/2),C=Math.round(I.height/2);else{const{clientX:z,clientY:L}=p.touches&&p.touches.length>0?p.touches[0]:p;B=Math.round(z-I.left),C=Math.round(L-I.top)}if(w)S=Math.sqrt((2*I.width**2+I.height**2)/3),S%2===0&&(S+=1);else{const z=Math.max(Math.abs((y?y.clientWidth:0)-B),B)*2+2,L=Math.max(Math.abs((y?y.clientHeight:0)-C),C)*2+2;S=Math.sqrt(z**2+L**2)}p!=null&&p.touches?b.current===null&&(b.current=()=>{T({pulsate:F,rippleX:B,rippleY:C,rippleSize:S,cb:R})},V.start(_t,()=>{b.current&&(b.current(),b.current=null)})):T({pulsate:F,rippleX:B,rippleY:C,rippleSize:S,cb:R})},[s,T,V]),W=u.useCallback(()=>{$({},{pulsate:!0})},[$]),v=u.useCallback((p,E)=>{if(V.clear(),(p==null?void 0:p.type)==="touchend"&&b.current){b.current(),b.current=null,V.start(0,()=>{v(p,E)});return}b.current=null,f(R=>R.length>0?R.slice(1):R),h.current=E},[V]);return u.useImperativeHandle(n,()=>({pulsate:W,start:$,stop:v}),[W,$,v]),j.jsx(Jt,{className:x(g.root,r.root,o),ref:D,...c,children:j.jsx(nt,{component:null,exit:!0,children:l})})});function ee(e){return Lt("MuiButtonBase",e)}const ne=ct("MuiButtonBase",["root","disabled","focusVisible"]),re=e=>{const{disabled:t,focusVisible:n,focusVisibleClassName:i,classes:s}=e,o=kt({root:["root",t&&"disabled",n&&"focusVisible"]},ee,s);return n&&i&&(o.root+=` ${i}`),o},se=tt("button",{name:"MuiButtonBase",slot:"Root"})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${ne.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),ce=u.forwardRef(function(t,n){const i=lt({props:t,name:"MuiButtonBase"}),{action:s,centerRipple:r=!1,children:o,className:c,component:l="button",disabled:f=!1,disableRipple:d=!1,disableTouchRipple:h=!1,focusRipple:M=!1,focusVisibleClassName:V,LinkComponent:b="a",onBlur:D,onClick:T,onContextMenu:$,onDragLeave:W,onFocus:v,onFocusVisible:p,onKeyDown:E,onKeyUp:R,onMouseDown:F,onMouseLeave:w,onMouseUp:U,onTouchEnd:y,onTouchMove:I,onTouchStart:B,tabIndex:C=0,TouchRippleProps:S,touchRippleRef:z,type:L,...O}=i,A=u.useRef(null),m=Kt(),ft=ot(m.ref,z),[k,H]=u.useState(!1);f&&k&&H(!1),u.useImperativeHandle(s,()=>({focusVisible:()=>{H(!0),A.current.focus()}}),[]);const dt=m.shouldMount&&!d&&!f;u.useEffect(()=>{k&&M&&!d&&m.pulsate()},[d,M,k,m]);const ht=P(m,"start",F,h),mt=P(m,"stop",$,h),bt=P(m,"stop",W,h),gt=P(m,"stop",U,h),Mt=P(m,"stop",a=>{k&&a.preventDefault(),w&&w(a)},h),Rt=P(m,"start",B,h),Et=P(m,"stop",y,h),yt=P(m,"stop",I,h),xt=P(m,"stop",a=>{ut(a.target)||H(!1),D&&D(a)},!1),Tt=G(a=>{A.current||(A.current=a.currentTarget),ut(a.target)&&(H(!0),p&&p(a)),v&&v(a)}),Z=()=>{const a=A.current;return l&&l!=="button"&&!(a.tagName==="A"&&a.href)},Ct=G(a=>{M&&!a.repeat&&k&&a.key===" "&&m.stop(a,()=>{m.start(a)}),a.target===a.currentTarget&&Z()&&a.key===" "&&a.preventDefault(),E&&E(a),a.target===a.currentTarget&&Z()&&a.key==="Enter"&&!f&&(a.preventDefault(),T&&T(a))}),Pt=G(a=>{M&&a.key===" "&&k&&!a.defaultPrevented&&m.stop(a,()=>{m.pulsate(a)}),R&&R(a),T&&a.target===a.currentTarget&&Z()&&a.key===" "&&!a.defaultPrevented&&T(a)});let _=l;_==="button"&&(O.href||O.to)&&(_=b);const Y={};_==="button"?(Y.type=L===void 0?"button":L,Y.disabled=f):(!O.href&&!O.to&&(Y.role="button"),f&&(Y["aria-disabled"]=f));const Vt=ot(n,A),st={...i,centerRipple:r,component:l,disabled:f,disableRipple:d,disableTouchRipple:h,focusRipple:M,tabIndex:C,focusVisible:k},It=re(st);return j.jsxs(se,{as:_,className:x(It.root,c),ownerState:st,onBlur:xt,onClick:T,onContextMenu:mt,onFocus:Tt,onKeyDown:Ct,onKeyUp:Pt,onMouseDown:ht,onMouseLeave:Mt,onMouseUp:gt,onDragLeave:bt,onTouchEnd:Et,onTouchMove:yt,onTouchStart:Rt,ref:Vt,tabIndex:f?-1:C,type:L,...Y,...O,children:[o,dt?j.jsx(te,{ref:ft,center:r,...S}):null]})});function P(e,t,n,i=!1){return G(s=>(n&&n(s),i||e[t](s),!0))}export{ce as B,nt as T,G as a,pt as b,Yt as c,Xt as d,rt as e,it as f,ut as i,ot as u};
